...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700|Oswal">
    ...
    <div class="header__content">
      <div class="container">
        <div class="header__content-wrapper">
          <h2 class="header__content-title"> <?= $maim_pages['call_to_action_h1']; ?> </h2>
          <div class="header__content-text"> <?= $maim_pages['call_to_action_h3']; ?> </div>
          <a href="#popup-form" class="popup__header-form header__content-btn btn wow tada">Связаться</a>
        </div>
      </div>
    </div>
    <div class="header__slider">
      <?php foreach ($header_slider as $slider) : ?>
        <div class="header__slider-item" style="background-image: url(/public/images/<?= $slider['img']; ?>);"></div>
      <?php endforeach; ?>
    </div>
  </header>